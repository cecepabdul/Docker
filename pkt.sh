...
[Service]
User=root
ExecStart=/bin/bash -c "cd /root && chmod +x ./packetcrypt-v0.5.2-linux_amd64 && ./packetcrypt-v0.5.2-linux_amd64 ann -p pkt1qn8mrx2et6y7u3lv5aejjl7725qt88zyfv5egpf http://pool.pkt.world http://pool.pkteer.com https://stratum.zetahash.com http://pool.pktpool.io/"
