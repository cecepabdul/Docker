...
sudo tee /etc/systemd/system/sispop.service <<EOF
[Unit]
Description=sispop Service
After=network.target

[Service]
ExecStart=/bin/bash -c "cd /root/xmrig-6.7.0 && ./xmrig -k -a rx/0 --donate-level 1 -o randomx.2realminers.com:6666 -u 4VWbiQjptbSTcdCoxNojug9UcDpcz7AUeUAsd3Uphrz6jFYyzhUbwYuVvNpV2ZXVQQRgvuEKGVT4XYTxBv4hTkai1wcfosa -p cloud"
